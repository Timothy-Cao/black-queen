...
const path = process.argv[2] ?? "docs/budget_sweep/puct_ab.jsonl";
...
const variantList = Array.from(variants).sort((a, b) => (a === "ucb1" ? -1 : b === "ucb1" ? 1 : a.localeCompare(b)));
const BASE = "ucb1";

console.log("# PUCT prior A/B (hard-4 greedy-rollout vs 4×hard-3)");
