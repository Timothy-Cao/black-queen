 ...
 * @returns {string}
 */
export function hard4_bid_json(state_json, self_id) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function hard4_declare_json(state_json, self_id) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function hard4_play_json(state_json, self_id, time_ms, seed) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 */
export function set_endgame_enabled_wasm(enabled) {
 ...
 * @param {boolean} enabled
 */
export function set_hard4b_wasm(enabled) {
 ...
 */
export function set_puct_wasm(enabled, c_x100, conc_x100) {
 ...
 * @param {number} depth
 */
export function set_tree_ismcts_wasm(enabled, depth) {
 ...
 * @param {number} c_x100
 */
export function set_ucb_c_wasm(c_x100) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('bq_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
