...
const path = process.argv[2] ?? "docs/budget_sweep/endgame_ab.jsonl";
...
const variantList = Array.from(variants).sort((a, b) => (a === "endgame_on" ? -1 : b === "endgame_on" ? 1 : a.localeCompare(b)));
const BASE = "endgame_on";

console.log("# Endgame on/off A/B (hard-4 greedy-rollout vs 4×hard-3)");
