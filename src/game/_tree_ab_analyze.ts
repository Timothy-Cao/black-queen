...
const path = process.argv[2] ?? "docs/budget_sweep/tree_ab.jsonl";
...
const variantList = Array.from(variants).sort((a, b) => (a === "flat" ? -1 : b === "flat" ? 1 : a.localeCompare(b)));
const BASE = "flat";

console.log("# Tree-ISMCTS A/B (hard-4 greedy-rollout vs 4×hard-3)");
