...
import { buildDeck5p, deal5pLight, shuffle, handSort } from "./deck.ts";
import { isLegalPlay, nextPlayer, trickPoints, trickWinner } from "./rules.ts";
import {
...
export function freshGame(
  playerConfigs: { name: string; isAI: boolean; aiPersonality?: import("./types.ts").AIPersonality }[],
  targetScore = 300,
